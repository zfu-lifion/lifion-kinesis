 ...
 *
 * @param {Object.<string, Function>} client - An instance of AWS.DynamoDB.
...
class DynamoDbClient {
   ...
   * @param {import('.').Logger} options.logger - An instace of a logger.
   ...
   *
   * @param {...*} args - The arguments.
   * @returns {Promise<DynamoDB.DescribeTableOutput>}
   */
  describeTable(...args) {
   ...
   *
   * @param {...*} args - The arguments.
   * @returns {Promise<DynamoDB.ListTagsOfResourceOutput>}
   */
   ...
   *
   * @param {...*} args - The arguments.
   * @returns {Promise<DynamoDB.DeleteItemOutput>}
   */
  delete(...args) {
   ...
   *
   * @param {...*} args - The arguments.
   * @returns {Promise<DynamoDB.UpdateItemOutput>}
   */
  update(...args) {
    const { docClient, retryOpts } = internal(this);
