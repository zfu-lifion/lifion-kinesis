 ...
 * @param {import('./kinesis-client')} params.client - An instance of the Kinesis client.
 * @param {import('.').Logger} params.logger - An instance of a logger.
 ...
 * @param {import('.').Logger} params.logger - An instance of the logger.
 ...
 *
 * @param {Object} params - The parameters.
 * @param {import('./kinesis-client')} params.client - An intance of the Kinesis client.
