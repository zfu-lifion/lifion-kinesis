...
describe('lib/table', () => {
  ...
  test('confirmTableTags defaults to an empty array if listTags returns undefined tags', async () => {
    listTagsOfResource.mockResolvedValueOnce({});
    await confirmTableTags({ client, logger, tableArn: 'foo', tags: {} });
  ...
  test('ensureTableExists defaults to creating a table if DynamoDB client returns an undefined table', async () => {
