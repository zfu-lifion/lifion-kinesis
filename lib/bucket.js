 ...
 * @param {S3Client} params.client - An instance of the S3 client.
 ...
 * @returns {Promise<void|Promise<S3.CreateBucketOutput>>} Resolves if the bucket exists and is accessible, rejects otherwise.
 * @memberof module:bucket
 */
