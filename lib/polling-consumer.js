 ...
 *
 * @param {import('./kinesis-client')} client - The AWS.Kinesis instance to use for the request.
 * @param {import('.').Logger} logger - An instance of a logger.
...
class PollingConsumer {
   ...
   * @param {import('./kinesis-client')} options.client - An instance of the Kinesis client.
   ...
   * @param {import('./s3-client')} options.s3Client - An instance of the S3 client.
   ...
   * @param {import('./state-store')} options.stateStore - An instance of the state store.
