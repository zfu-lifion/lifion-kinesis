 ...
 *
 * @param {Object.<string, any>} err - The error thrown by a request or call on a retry attempt.
 ...
 *
 * @param {any} err - The error instance to transform.
 * @param {Object.<string, string>} [stackObj] - An object that stores a captured error stack.
 ...
 * @returns {Object.<string, string>|undefined} An object with a captured stack trace (if enabled).
 * @memberof module:utils
 */
