...
describe('lib/stream', () => {
  ...
  test('getEnhancedConsumers defaults to an empty object if client returns undefined consumers', async () => {
  ...
  test('getStreamShards defaults with an empty object if client returns undefined shards', async () => {
  ...
  test('registerEnhancedConsumer defaults to an empty array of consumers if client returns undefined consumers', async () => {
    registerStreamConsumer.mockResolvedValueOnce({ Consumer: { ConsumerStatus: 'CREATING' } });
    listStreamConsumers.mockResolvedValueOnce({});
    listStreamConsumers.mockResolvedValueOnce({
    ...
    await registerEnhancedConsumer(commonParams);
