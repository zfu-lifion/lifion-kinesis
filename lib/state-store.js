...
/**
 * @typedef ShardData
 * @property {Object.<string, Shard>} shards
 * @property {string} shardsPath
 * @property {Object.<string, string>} shardsPathNames
 */

/**
 * @typedef StreamState
 * @property {string} consumerGroup
 * @property {Object.<string, Consumer>} consumers
 * @property {Object.<string, EnhancedConsumer>} enhancedConsumers
 * @property {Object.<string, Shard>} shards
 * @property {?string} streamCreatedOn
